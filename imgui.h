...
struct ImColor
{
    ...
    inline ImColor operator() (int a)                               { Value.w = 255.0f / a; return ImGui::ColorConvertFloat4ToU32(Value); }
    inline ImColor operator() (float a)                             { Value.w = a; return Value; };
