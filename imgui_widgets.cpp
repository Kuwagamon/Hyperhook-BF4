...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    if (mixed_value)
    {
        ...
        window->DrawList->AddRectFilledMultiColor(
            check_bb.Min + ImVec2(2, 2), check_bb.Max - ImVec2(2, 2),
            ImColor(71, 71, 71), ImColor(71, 71, 71),
            ImColor(56, 56, 56), ImColor(56, 56, 56));
    }
    else if (*v)
    {
        ...
        window->DrawList->AddRectFilledMultiColor(
            check_bb.Min + ImVec2(2, 2), check_bb.Max - ImVec2(2, 2), 
            ImColor(135, 181, 53), ImColor(135, 181, 53), 
            ImColor(97, 128, 42), ImColor(97, 128, 42));
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    if (grab_bb.Max.x > grab_bb.Min.x)
        ...
        window->DrawList->AddRectFilledMultiColor(
            { frame_bb.Min.x + 1, frame_bb.Min.y + 1 }, 
            { grab_bb.GetCenter().x, frame_bb.Max.y - 1 }, 
            ImColor(135, 181, 53), ImColor(42, 127, 128),
            ImColor(42, 127, 128), ImColor(97, 128, 42));
